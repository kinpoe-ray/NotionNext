...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'matery', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 gitbook,matery,hexo,next,plog,medium,example,fukasawa,heo,landing,nobelium,simple
